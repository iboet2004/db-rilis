...
def main():
    # Load data
    df_sp = load_dataset("db_siaran_pers.csv")
    df_berita = load_dataset("db_berita.csv")
    
    # Define column names
    sp_title_col = df_sp.columns[1]
    sp_date_col = df_sp.columns[0]
    entity_col = df_berita.columns[4]
    date_col = df_berita.columns[0]
